...
public class Querry5 {
    ...
    public static void main(String[] args) {
        ...
        for (int i=2; i<7009729; i++)
            ...
            System.out.println("Month day counter :" + mnt[k] + " days");
            System.out.println("the sum airtime :" + sumair[k] + " minutes");
            System.out.println("the min airtime :" + minair[k] + " minutes");
            System.out.println("the max airtime :" + maxair[k] + " minutes");
            System.out.println("the avg :" + avg[k] + " day");
            System.out.println("the avg airtime :" + sumair[k]/avg[k] + " minutes");
            System.out.println("--------------------------------------");
            }
